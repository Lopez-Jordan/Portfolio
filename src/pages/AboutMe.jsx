    ...
    return (
        <>
            <div className="introDiv">
                ...
                <p className="text">A Software Developer with a strong background in industry-standard Full Stack technologies, Mathematics, Economics,
                    and Consulting. This website was made with React and vanilla CSS--no templates!
